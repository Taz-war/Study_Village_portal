    ...
    <Box height={"100%"} minWidth={'420px'}>
      ...
      >
        ...
        <Box display={"flex"} justifyContent={"space-evenly"} flexWrap={"wrap"}>
          ...
          >
            <Box width={'100%'} borderBottom={'1px solid yellow'} height={'40px'} textAlign={'left'}>
                  <YouTube fontSize="large" sx={{color:'yellow',marginLeft:2}} />
                </Box>
          ...
          >
            <Box width={'100%'} borderBottom={'1px solid yellow'} height={'40px'} textAlign={'left'}>
                  <DownloadForOfflineRoundedIcon fontSize="large" sx={{color:'yellow',marginLeft:2,mt:0.4}} />
                </Box>
                <Box width={'100%'} height={'260px'}>
        ...
        <Box
          ...
          color={"white"}
          justifyContent={"center"}
          sx={{ backgroundColor: "#2fafd4",height:{lg:'30px',md:'30px',sm:'30px',xs:'60px'},width:{lg:'400px',md:'400px',sm:'400px',xs:'300px'} }}
          ml={4}
          mt={3}
          pt={1}
        >
        ...
        <Box
          ...
          color={"white"}
          justifyContent={"center"}
          sx={{ backgroundColor: "#2fafd4",width:{
            xs:'65%',
            lg:'500px',
            md:'500px'
          },
          height:{
            xs:'60px',lg:'30px',md:'30px'
          }
        }}
          ml={4}
          mt={3}
        ...
        <Grid container spacing={2} columns={16}>
            <Grid item lg={5} md={5} xs={8} mb={15} ml={3.5} >
              <Item sx={{border:'1px solid yellow',color:'white',height:'315px',p:0}}>
                <Box width={'100%'} borderBottom={'1px solid yellow'} height={'40px'} textAlign={'left'}>
                  <YouTube fontSize="large" sx={{color:'yellow',marginLeft:2}} />
                </Box>
                <Box width={'100%'} height={'260px'}>
            ...
            <Grid item lg={2} md={2} xs={4} mb={15} ml={2}>
              <Item sx={{border:'1px solid yellow',color:'white',height:'315px',p:0}}>
              <Box width={'100%'} borderBottom={'1px solid yellow'} height={'40px'} textAlign={'left'}>
                  <SignalCellularAlt fontSize="large" sx={{color:'yellow',marginLeft:2}} />
                </Box>
                <Box width={'100%'} height={'260px'}>
